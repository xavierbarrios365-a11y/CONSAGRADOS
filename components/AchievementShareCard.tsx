...
const AchievementShareCard: React.FC<AchievementShareCardProps> = ({ agent, newsItem, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[250] bg-black/98 flex flex-col items-center justify-center p-4 animate-in fade-in backdrop-blur-3xl overflow-hidden">
            ...
            {/* Template Container */}
            <div
                className="relative shadow-[0_80px_250px_rgba(0,0,0,1)] rounded-[50px] overflow-hidden bg-black"
                style={{
            ...
            >
                <div
                    ref={exportRef}
                    className={`w-[1080px] h-[1920px] bg-gradient-to-b ${config.bgGradient} relative overflow-hidden flex flex-col items-center origin-top-left`}
            ...
            <p className="mt-8 text-white/20 text-[10px] font-black uppercase tracking-[1em] mb-6">Consagrados Command Center • Final Perfection v1000</p>
        </div>
    );
};
